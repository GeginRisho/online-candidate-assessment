...
export default function LandingPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-50/30 text-slate-900 antialiased">
      {/* Navbar */}
      <header className="border-b border-slate-100 bg-white/80 backdrop-blur-md sticky top-0 z-50">
        ...
        {/* Mobile Nav Menu */}
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-slate-100 bg-white px-6 py-4 flex flex-col gap-4 shadow-inner">
            <Link
              href="/login"
        ...
        <div className="grid gap-12 md:grid-cols-12 items-center w-full">
          ...
          <div className="md:col-span-5 flex justify-center md:justify-end w-full">
            <div className="w-full max-w-[360px]">
              <Card className="backdrop-blur-md bg-white/70 border border-white/40 shadow-xl rounded-2xl overflow-hidden card-shadow">
